                        ...
                        <div class="card" style="border-radius: 1rem;">
                            <div class="row g-0">
                                <div class="col-md-6 col-lg-5 d-none d-md-block py-5">
                                    <img src="image/kkulogo.png" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" />
                                </div>
                                    ...
                                    <div class="card-body p-4 p-lg-5 text-black">
                                        ...
                                        <form name="frmlogin" method="post" action="c_login.php">
                                            ...
                                            <div class="form-input mb-4">
                                                <input type="password" id="Username" name="Username" class="form-control form-control-lg" placeholder="กรอกเบอร์ผู้ปกครอง(คุณแม่)เพื่อเข้าใช้งาน" />
                                            </div>
                                            <div class="pt-1 mb-4">
                                                <button class="btn btn-dark btn-lg btn-block" type="submit">เข้าใช้งาน</button>
                                            </div>
                                        </form>
