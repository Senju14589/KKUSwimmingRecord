...
if (isset($_POST['insert2'])) {
    ...
    $sql = $insertdata->insert2($name, $lastname, $nickname, $sexbaby, $birthday, $agebaby, $path, $parent_id, $status);
...
if (isset($_POST['update2'])) {
    ...
    $sql = $updatedata->update4($inquiry_id, $study, $location, $anytime, $level, $pool, $disease, $details);
                           ...
                           <table id="example" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                 <?php
                                            ...
                                            ?>
                                 <tr>
                                    <td><img src="<?php echo $row['image']; ?>" width="100px" height="100px" alt=""
                                          </td>
                                                   ...
                                                   <div class="row">
                                                      <div class="col-md-6 img">
                                                         <img src="<?php echo $row['image']; ?>" width="200px"
                                                            height="200px" alt="" class="img-rounded">
                                                      </div>
                                                         ...
                                                         <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                               <nav class="navbar bg-light">
                                                                  <div class="container-fluid">
                                                                     <a class="navbar-brand" href="#">
                                                                        <img src="image1 KKU new.png" alt="" width="30"
                                                                           height="24"
                                                                        ...
                                                                        <div class="row">
                                                                           ...
                                                                           <div
                                                                              ...
                                                                              <div class="input-group mb-4">
                                                                                 ...
                                                                                 <input type="text" name="phonefather"
                                                                                    class="form-control"
                                    ...
                                    <td><a href="newuser.php?del=<?php echo $row['id']; ?>" class="btn btn-danger"
                  ...
                  <form action="newuser.php" method="post" enctype="multipart/form-data">
                     <div class="row">
                        <div class="col-12 col-md-12 col-lg-6 mb-8 mb-lg-2">
                           ...
                           <div class="input-group mb-3">
                              <input type="text" class="form-control mt-4" name="name" placeholder="ชื่อจริง" required>
                           ...
                           <div class="input-group mb-3">
                              ...
                              <input type="number" name="agebaby" class="form-control" placeholder="อายุ" required>
                           </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-6 mb-8 mb-lg-4">
                           ...
                           <div class="mb-3">
                              <input type="text" class="form-control" name="namefather" placeholder="ชื่อ-สกุล บิดา"
                                 required>
                           </div>
                           <div class="input-group mb-4">
                              ...
                              <input type="text" name="phonefather" class="form-control" placeholder="เบอร์โทรศัพท์"
                                 required>
                           </div>
                           <div class="mb-4">
                              <input type="email" class="form-control" name="emailfather" placeholder="E-mail" required>
                           </div>
                           <div class="mb-4">
                              <input type="text" name="namemother" class="form-control" placeholder="ชื่อ-สกุล มารดา"
                                 required>
                           </div>
                           <div class="input-group mb-4">
                              ...
                              <input type="text" class="form-control" name="phonemother" placeholder="เบอร์โทรศัพท์"
                                 required>
                           </div>
                           <div class="mb-4">
                              <input type="email" class="form-control" name="emailmother" placeholder="E-mail" required>
                           </div>
                           <div class="mb-4">
                        ...
                        <div class="center">
                           <div class="col-12">
                              ...
                              <p>
                                 ...
                                 <input type="radio" name="pool" value="กลัวมาก"> กลัวมาก
                                 <br>
                                 <input type="radio" name="pool" value="ค่อนข้างกลัวน้ำ">
                                 ค่อยข้างกลัวน้ำ
                                 <br>
                                 <input type="radio" name="pool" value="ปานกลาง"> ปานกลาง
                                 <br>
                                 <input type="radio" name="pool" value="คุ้นเคย"> คุ้นเคย
                                 <br>
                                 <input type="radio" name="pool" value="ชอบน้ำมาก"> ชอบน้ำมาก
                                 <br>
                              </p>
                              <p>
                                 3.น้องมีโรคประจำตัวหรือไม่
                                 <input type="radio" name="disease" value="YES"> Y
                                 <input type="radio" name="disease" value="NO"> N
                                 <br><br>
                                 รายละเอียด
                              <div class="input-group">
