...
if (isset($_POST['username'])) {
    ...
    $stmt = $conn->prepare("SELECT phonemother FROM parentdetail WHERE username = :phonemother");
    ...
    if ($stmt->rowCount() == 1) {
        ...
        //สร้างตัวแปร session
        $_SESSION['id'] = $row['id'];
        $_SESSION['phonemother'] = $row['phonemother'];
        ...
        header('Location: includes/sportuser.php'); //login ถูกต้องและกระโดดไปหน้าตามที่ต้องการ
                                        ...
                                        <form>
                                            ...
                                            <div class="pt-1 mb-4">
                                                <button class="btn btn-dark btn-lg btn-block" type="button"
                                                    name="login_user">เข้าใช้งาน</button>
                                            </div>
